...
namespace Hashes
{
	...
	const Hash CUST_PARTS_GENERIC_ATTACHMENT_ICON = 0x9FABCD33;
	const Hash OPTION_1 = 0x4B4E3888;
	const Hash CURRENT_OPTION = 0x08143B9A;
	const Hash CARBON_SKIN = 0x73E50508;
	...
	const Hash FRONT_DECAL = 0xA4E9EC00;
	const Hash REAR_DECAL = 0xB2FE5161;

	const Hash NORMAL_HELP = 0x53E91F30;
	const Hash CARBON_HELP = 0x73DEE3BC;
	...
	const Hash CUST_PARTS_HOODS = 0xA234CD03;
	const Hash CUST_PARTS_WHEELS = 0x0B47AB2E;
	const Hash CUST_PARTS_SPOILERS = 0xCA4588D7;
	const Hash CUST_PARTS_CARBON = 0xDC28E79B;
	const Hash CUST_PARTS_NORMAL = 0xF6CF2A8F;
	const Hash CUST_MATERIAL = 0xFA78312C;
	const Hash CUST_COLOR = 0xF4AFDD3C;
	const Hash CUST_CHANGESIZE = 0x9248AAFE;
	const Hash CUST_PARTS_WHITE = 0xA3404E67;
	const Hash CUST_PARTS_BLACK = 0xA1C65923;
